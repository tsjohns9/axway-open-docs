...
Amplify Central *mesh governance* enables you to govern and manage your pubilc and private APIs, along with the hybrid environments where they are located. Amplify Central provides a centralized SaaS control plane, and you define the data plane where the governance policies are enforced (Axway public cloud or your private cloud).
...
The data plane in an Amplify Central hybrid environment. It is split into a service mesh data plane and control plane.
